...
def draw_image(sample,los_class,subhalo_class,main_deflector_class,
	...
	if subhalo_class is not None:
		...
		# print(complete_lens_model_list, complete_lens_model_kwargs)
	...
	# print(complete_lens_model_list[:1], z_lens, z_source,complete_z_list)

	complete_lens_model_list = complete_lens_model_list[:1]
	...
	# Generate our image
	# print(complete_lens_model_kwargs)
	# print(complete_lens_model_kwargs[:1])
	# print(source_kwargs_list, lens_light_kwargs_list)
	complete_lens_model_kwargs = complete_lens_model_kwargs[:1]
	complete_lens_model_kwargs = None
	if lens_light_class is not None:
		# print(lens_light_model, lens_light_kwargs_list)
		lens_light_kwargs_list[0]['center_x']=complete_lens_model_kwargs[0]['center_x']
		lens_light_kwargs_list[0]['center_y']=complete_lens_model_kwargs[0]['center_y']
	# print(lens_light_kwargs_list)
	# print(LightModel(['INTERPOL']).total_flux(source_kwargs_list))
	# print(LightModel(['SERSIC_ELLIPSE']).total_flux(lens_light_kwargs_list))
	image = complete_image_model.image(complete_lens_model_kwargs,
		source_kwargs_list, lens_light_kwargs_list, point_source_kwargs_list, lens_light_add=False)
	...
	while nt < args.n:
		...
		for component in sample:
			for key in sample[component]:
				...
				elif isinstance(comp_value, np.ndarray):
					meta_values[component+'_'+key] = comp_value[0]
