...
class SubhalosDG19(SubhalosBase):
	...
	def convert_to_lenstronomy(self,subhalo_masses,subhalo_cart_pos):
		...
		concentration = np.array([12.13342734])
		# print(list(concentration))
		# print(list(subhalo_masses))
	...
	def draw_subhalos(self):
		...
		subhalo_kwargs_list[0]['center_x'] = r*np.cos(theta)
		subhalo_kwargs_list[0]['center_y'] = r*np.sin(theta)
		# print(r*np.cos(theta), r*np.sin(theta))
		# print(subhalo_kwargs_list)
