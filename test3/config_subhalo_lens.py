...
config_dict = {
	'subhalo':{
		...
		'parameters':{
			...
			'm_pivot': 1e10,'m_min': 1e10,'m_max': 1e13,
	...
	'source':{
		...
		'parameters':{
			'z_source':6,
			'output_ab_zeropoint':output_ab_zeropoint,
			'file':"../datasets/UDF/4110i.npy", 'scale':.03, 'amp':131250,
			'center_x':norm(loc=0.0,scale=0.0).rvs,
			'center_y':norm(loc=0.0,scale=0.0).rvs}
	},
	'cosmology':{
	...
	'detector':{
		'parameters':{
			...
			'exposure_time':3600,#1380,
			'sky_brightness':21.83,
